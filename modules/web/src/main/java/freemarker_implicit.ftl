...
[#-- @ftlvariable name="Membership" type="billiongoods.core.Membership.static" --]
[#-- @ftlvariable name="Language" type="billiongoods.core.Language.static" --]

[#-- @ftlvariable name="springSecurityContext" type="billiongoods.server.web.servlet.view.freemarker.SpringSecurityContext" --]