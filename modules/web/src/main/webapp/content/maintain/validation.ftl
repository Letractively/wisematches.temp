                ...
                <tr>
                    ...
                    <#else>
                        ...
                        ${r.oldPrice.amount?string("0.00")}
                            (<#if r.oldPrice.primordialAmount??>${r.oldPrice.primordialAmount?string("0.00")}<#else>
                            -</#if>)
                        </td>
                        <td>
                        ${r.newPrice.amount?string("0.00")}
                            (<#if r.newPrice.primordialAmount??>${r.newPrice.primordialAmount?string("0.00")}<#else>
                            -</#if>)
                        </td>
                        <td>
