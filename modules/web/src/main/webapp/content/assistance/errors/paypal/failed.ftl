...
<p>
    Мы так же проведем внутренний анализ ошибки в ближайшее время. Пожалуйста, оставьте ваш адрес
    электронной
    почты если вы хотели бы получить результат анализа и информацию о возможном устранении ошибки:
</p>

<form>
    <input type="hidden" name="token" value="${exception.tnxId}"/>
    <input name="email" value="" style="width: 140px">
