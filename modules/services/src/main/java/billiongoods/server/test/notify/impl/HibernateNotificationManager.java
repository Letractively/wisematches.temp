...
import billiongoods.server.test.notify.NotificationDescriptor;
import billiongoods.server.test.notify.NotificationManager;
...
//        checkTable(session, "notification_timestamp");
	...
	@Override
	public NotificationScope setNotificationScope(String code, Member player, NotificationScope scope) {
