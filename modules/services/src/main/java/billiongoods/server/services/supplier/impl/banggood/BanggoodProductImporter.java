    ...
    protected List<SuppliedProduct> parseProducts(InputStream stream) throws IOException {
        ...
        while ((nextLine = reader.readNext()) != null) {
            ...
            try {
                ...
                final double price = Double.parseDouble(nextLine[4]);
                final double weight = Double.parseDouble(nextLine[5]);
                final String desc = cleanSpan(nextLine[6]);
                final URL url = new URL(nextLine[7]);
