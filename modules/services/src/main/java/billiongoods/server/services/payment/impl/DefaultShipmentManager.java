...
public class DefaultShipmentManager implements ShipmentManager {
    private static final double DEFAULT_MAIL_COST = 0f;
    private static final double REGISTERED_MAIL_COST = 1.70f;
    private static final double REGISTERED_MAIL_AMOUNT = 25f;
