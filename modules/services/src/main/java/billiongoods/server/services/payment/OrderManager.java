...
public interface OrderManager extends SearchManager<Order, OrderContext, Void> {
     ...
     * @param note     appropriate note.
     */
    Order cancel(Long orderId, String refundId, String note);
     ...
     * @return update order
     */
    Order process(Long orderId, Long parcelId, Integer... items);
    ...
    Order suspend(Long orderId, Long parcelId, Date resume, String note);

    Order cancel(Long orderId, Long parcelId, String refundId, String note);

    Order close(Long orderId, Long parcelId, Date delivered, String note);
