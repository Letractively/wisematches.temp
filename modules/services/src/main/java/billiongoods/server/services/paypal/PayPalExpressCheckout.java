...
public class PayPalExpressCheckout implements InitializingBean {
    ...
    private SetExpressCheckoutResponseType setExpressCheckout(Long tnxId, Order order, String orderURL,
        ...
        for (OrderItem orderItem : orderItems) {
            ...
            item.setAmount(new BasicAmountType(CURRENCY_CODE, PriceMath.string(orderItem.getAmount())));
        ...
        paymentDetails.setItemTotal(new BasicAmountType(CURRENCY_CODE, PriceMath.string(order.getAmount())));
        paymentDetails.setShippingTotal(new BasicAmountType(CURRENCY_CODE, PriceMath.string(order.getShipment())));
        paymentDetails.setOrderTotal(new BasicAmountType(CURRENCY_CODE, PriceMath.string(order.getAmount() + order.getShipment())));
