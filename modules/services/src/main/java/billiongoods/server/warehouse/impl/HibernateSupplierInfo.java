...
public class HibernateSupplierInfo implements SupplierInfo {
    ...
    public HibernateSupplierInfo(String referenceId, String referenceCode, Supplier wholesaler, double price, Float primordialPrice) {
        this.price = price;
    ...
    void setPrimordialPrice(Float primordialPrice) {
        this.primordialPrice = primordialPrice;
    }
