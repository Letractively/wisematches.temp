...
public class BanggoodPriceLoaderTest {
	...
	public void asd() throws PriceLoadingException {
		BanggoodPriceLoader priceValidator = new BanggoodPriceLoader();
		final Price price = priceValidator.loadPrice(new HibernateSupplierInfo("/Wholesale-Replacement-WLtoys-V911-2_4GHz-4CH-RC-Helicopter-BNF-New-Plug-Version-p-39473.html", "SKU044199 ", Supplier.BANGGOOD, null));
