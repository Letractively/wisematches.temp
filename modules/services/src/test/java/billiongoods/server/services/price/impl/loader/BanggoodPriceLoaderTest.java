...
public class BanggoodPriceLoaderTest {
	...
	public void test() throws Exception {
		...
		final URL s = priceValidator.parseJavaScriptRedirect(response);
		assertEquals("http://www.banggood.com/j?LuyFdiD4uEh6dL/5ulRPOi9XbHRveXMtTDk1OS0xMS1Gcm9udC1TdXNwZW5zaW9uLVN1cHBvcnQtTWVtYmVyLUZvci1XbHRveXMtTDk1OS1wLTc1NjkyLmh0bWw=", s.toExternalForm());
	}

	@Test
	public void asd() throws PriceLoadingException {
		BanggoodPriceLoader priceValidator = new BanggoodPriceLoader();
		final Price price = priceValidator.loadPrice(new HibernateSupplierInfo("-p-83053.html", "SKU068185 ", Supplier.BANGGOOD, null));
